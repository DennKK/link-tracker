...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record3<Long, String, OffsetDateTime> {
    ...
    @Override
    @NotNull
    public LinksRecord values(@NotNull Long value1, @NotNull String value2, @NotNull OffsetDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
    ...
    public LinksRecord(@NotNull Long linkId, @NotNull String url, @NotNull OffsetDateTime updatedAt) {
        super(Links.LINKS);
