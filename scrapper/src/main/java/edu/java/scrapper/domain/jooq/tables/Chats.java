...
public class Chats extends TableImpl<ChatsRecord> {
     ...
     */
    public final TableField<ChatsRecord, Integer> CHAT_ID =
        createField(DSL.name("CHAT_ID"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>CHATS.REGISTERED_AT</code>.
     */
    public final TableField<ChatsRecord, OffsetDateTime> REGISTERED_AT =
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function2<? super Integer, ? super OffsetDateTime, ? extends U> from
    ) {
