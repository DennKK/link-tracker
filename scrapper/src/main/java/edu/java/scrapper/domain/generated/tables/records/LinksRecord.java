...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record4<Long, String, OffsetDateTime, OffsetDateTime> {
    ...
    @Override
    @NotNull
    public LinksRecord values(@NotNull Long value1, @NotNull String value2, @NotNull OffsetDateTime value3, @NotNull OffsetDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinksRecord(@NotNull Long linkId, @NotNull String url, @NotNull OffsetDateTime checkedAt, @NotNull OffsetDateTime updatedAt) {
        super(Links.LINKS);
     ...
     * Create a detached, initialised LinksRecord
     */
    public LinksRecord(edu.java.scrapper.domain.generated.tables.pojos.Links value) {
        super(Links.LINKS);
